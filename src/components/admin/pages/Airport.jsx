...
const Airport = () => {
  ...
  const [airports, setAirports] = useState([
    { id: 1, name: 'Indira Gandhi International Airport', code: 'DEL', city: 'New Delhi', status: 'Active' },
    { id: 2, name: 'Chhatrapati Shivaji International Airport', code: 'BOM', city: 'Mumbai', status: 'Active' },
    { id: 3, name: 'Kempegowda International Airport', code: 'BLR', city: 'Bangalore', status: 'Active' },
    { id: 4, name: 'Chennai International Airport', code: 'MAA', city: 'Chennai', status: 'Active' },
    { id: 5, name: 'Netaji Subhas Chandra Bose Airport', code: 'CCU', city: 'Kolkata', status: 'Active' },
    { id: 6, name: 'Rajiv Gandhi International Airport', code: 'HYD', city: 'Hyderabad', status: 'Active' },
    { id: 7, name: 'Cochin International Airport', code: 'COK', city: 'Kochi', status: 'Inactive' },
    { id: 8, name: 'Pune Airport', code: 'PNQ', city: 'Pune', status: 'Active' },
    { id: 9, name: 'Sardar Vallabhbhai Patel International Airport', code: 'AMD', city: 'Ahmedabad', status: 'Active' },
    { id: 10, name: 'Goa International Airport', code: 'GOI', city: 'Goa', status: 'Active' },
    { id: 11, name: 'Jaipur International Airport', code: 'JAI', city: 'Jaipur', status: 'Active' },
    { id: 12, name: 'Lucknow Airport', code: 'LKO', city: 'Lucknow', status: 'Active' },
    { id: 13, name: 'Thiruvananthapuram International Airport', code: 'TRV', city: 'Thiruvananthapuram', status: 'Active' },
    { id: 14, name: 'Chandigarh International Airport', code: 'IXC', city: 'Chandigarh', status: 'Active' },
    { id: 15, name: 'Coimbatore International Airport', code: 'CJB', city: 'Coimbatore', status: 'Active' },
  ]);
  ...
  const handleEdit = (airport) => {
    ...
    setFormData({ name: airport.name, code: airport.code, city: airport.city, status: airport.status });
  ...
  const handleAddSubmit = (e) => {
    e.preventDefault();
    const newAirport = { id: airports.length + 1, ...formData };
    setAirports([...airports, newAirport]);
    setIsAddModalOpen(false);
    setFormData({ name: '', code: '', city: '', status: 'Active' });
  };

  const handleEditSubmit = (e) => {
    e.preventDefault();
    setAirports(airports.map(airport => 
      airport.id === selectedAirport.id ? { ...airport, ...formData } : airport
    ));
