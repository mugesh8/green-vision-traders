    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto">
          ...
          <button
            onClick={() => navigate('/drivers/DRV-001/local-pickups')}
          ...
          <button
            onClick={() => navigate('/drivers/DRV-001/daily-payout')}
            className="px-6 py-2.5 rounded-lg font-medium transition-all text-sm bg-white text-gray-600 hover:bg-gray-50 border border-gray-200 whitespace-nowrap"
          >
            Daily Payout
          </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${
                    driverInfo.status === 'Available' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'
                  }`}>
                    <span className={`w-2 h-2 rounded-full ${
                      driverInfo.status === 'Available' ? 'bg-emerald-500' : 'bg-red-500'
                    }`}></span>
                    {driverInfo.status}
                  </span>
                </div>
